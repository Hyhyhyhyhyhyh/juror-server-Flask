...
词频分析      GET        /api/analyze/wordfrequency/<string:database>/<string:table_name>/<string:col_name>
```
...
# gunicorn运行Flask项目
```
cd /data/pyweb/juror-server
nohup gunicorn -c /data/pyweb/juror-server/gconfig.py run:app &
```
